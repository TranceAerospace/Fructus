            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        Text("If you wish, you can restart th application by the toggle switch in this box. That way it starts the onboarding process and you will see the welcome screen again.")
                            .padding(.vertical, 8)
                            .frame(minHeight: 60)
                            .layoutPriority(1)
                            .font(.footnote)
